...
syn keyword IsabelleCommandProofIsar assume presume show have from then thus hence
syn keyword IsabelleCommandProofIsar with next using note def unfolding
